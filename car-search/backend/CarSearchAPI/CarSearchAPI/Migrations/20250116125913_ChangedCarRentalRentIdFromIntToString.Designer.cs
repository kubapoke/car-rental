...
namespace CarSearchAPI.Migrations
{
    ...
    [Migration("20250116125913_ChangedCarRentalRentIdFromIntToString")]
    partial class ChangedCarRentalRentIdFromIntToString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarSearchAPI.Models.Rent", b =>
                {
                    ...
                    b.Property<string>("RentalCompanyRentId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
